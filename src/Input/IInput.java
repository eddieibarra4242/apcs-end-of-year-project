...
public interface IInput {
	 ...
	 * @param code
	 *            The key to test
	 * @return Whether or not key is currently pressed, but not if it has been pressed already.
	 */
	 ...
	 * @param code
	 *            The key to test
	 * @return Whether or not key has just been released.
	 */
	 ...
	 * @param button
	 *            The button to test
	 * @return Whether or not the button is currently pressed, but not if it has been pressed already.
	 */
	...
	/**
	 * Gets the location of the mouse cursor on x and y, in normalized device coordinates (-1, 1).
	 * 
	 * @return The location of the mouse cursor on x and y, in normalized device coordinates (-1, 1)
	 */
	public Vector2f getMouse2D();

	/**
	 * Gets the amount the mouse has moved since the previous update on X and Y.
	 * 
	 * @return The amount the mouse has moved since the previous update on X and Y.
	 */
